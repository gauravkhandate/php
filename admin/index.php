...
<head>
    <meta charset="utf-8">
    <title>Rangrasia | Admin Dashboard</title>
                                            ...
                                            <form method="GET" action="" id="searchForm">
                                                <div class="gridjs-head">
                                                    <div class="gridjs-search">
                                                        ...
                                                        <a href="index.php" class="btn btn-secondary btn-sm ml-2">Clear Search</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <table role="grid" class="gridjs-table" style="height:auto;">
                                                <thead class="gridjs-thead">
                                                    <tr class="gridjs-tr">
                                                        ...
                                                        <th>Mobile Number</th>
                                                        <th>Email</th>
                                                        <th>Action</th> <!-- New column for the View Profile button -->
                                                    </tr>
                                                </thead>
                                                <tbody class="grid-tbody">
                                                    ...
                                                    // Query to fetch user details from registrations table
                                                    $query = "SELECT * FROM registrations";
                                                    
                                                    // Add search condition if applicable
                                                    if ($search) {
                                                        $query .= " WHERE fullName LIKE '%$search%' OR mobileNumber LIKE '%$search%' OR email LIKE '%$search%'";
                                                    }
                                                    ...
                                                    if ($result && mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            ...
                                                            <tr class="gridjs-tr">
                                                                ...
                                                                <td class="gridjs-td"><?php echo htmlspecialchars($row['fullName']); ?></td> <!-- Use htmlspecialchars for security -->
                                                                <td class="gridjs-td"><?php echo htmlspecialchars($row['residence']); ?></td>
                                                                <td class="gridjs-td"><?php echo htmlspecialchars($row['mobileNumber']); ?></td>
                                                                <td class="gridjs-td"><?php echo htmlspecialchars($row['email']); ?></td>
                                                                <td class="gridjs-td">
                                                                    <a href="view_profile.php?user_id=<?php echo $row['id']; ?>" class="btn btn-primary">View Profile</a>
                                                                </td>
                                                            </tr>
                                                            <?php
                                                        }
